...
public class Class_TC4 {
	...
	public void SignInVideoSubscribe() throws InterruptedException {
		Thread.sleep(8000);
		/*
		 * WebElement signinlnk2 =
		 * cdriver4.findElement(By.xpath("//yt-formatted-string[text()='Sign in']"));
		 * signinlnk2.click(); WebElement uname1 =
		 * cdriver4.findElement(By.xpath("//input[@aria-label='Email or phone']"));
		 * uname1.sendKeys("kunalselinium"); WebElement next21 =
		 * cdriver4.findElement(By.xpath("//span[@class='RveJvd snByac']"));
		 * next21.click(); Thread.sleep(3000); WebElement pass1 =
		 * cdriver4.findElement(By.xpath("//input[@type='password']"));
		 * pass1.sendKeys("Kunal98765"); WebElement next22 =
		 * cdriver4.findElement(By.xpath("//span[text()='Next']")); next22.click();
		 */
		Thread.sleep(10000);
		/*
		...
		// subscribe=cdriver4.findElement(By.xpath("(//div[@id='subscribe-button'])[7]"));
		  ...
		  subscribe1=cdriver4.findElements(By.xpath("//yt-formatted-string[@class='style-scope ytd-subscribe-button-renderer']"));
		  System.out.println(subscribe1.size()); 
		  //subscribe1.get(6).click();
		  
		  
		  for (WebElement e:subscribe1) 
		  { if(e.getText().equals("Subscribe") ) {
		  e.click();
		  break;
		  }
	 ...
	 * Thread.sleep(10000); cdriver4.close(); }
	 * 
	 */
}
